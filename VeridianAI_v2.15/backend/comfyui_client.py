...
def generate_image(prompt: str, *, negative: Optional[str] = None,
                   ...
                   poll_interval: float = 1.0, ns=None) -> Dict[str, Any]:
    ...
    try:
        ...
        with open(out_path, "wb") as f:
            # The folder is already per-profile (downloads_dir, passed by
            # the caller); the bytes must be encrypted for the same
            # profile or the image lands somewhere it cannot be opened.
            f.write(atrest.encrypt_bytes(png, ns=ns))
