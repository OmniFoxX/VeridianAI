...
def test_normalize_zero():
    ...
    # normalize_scores returns a LIST; this indexed it like a dict, so the
    # assertion could never run -- it raised TypeError and was reported as
    # a failing test rather than a broken one.
    assert out[0]["score"] == 5
    assert out is not results        # documented as returning a new list
