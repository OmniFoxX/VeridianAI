...
def semantic_search(query: str,
    ...
    for fname in missing:
        try:
            ...
            import atrest
            # v2.14.3: the PATHS handed in are already per-profile (see
            # sage_engine.semantic_search); the decryption has to match,
            # or a profile-encrypted archive silently fails to index and
            # that profile's semantic search quietly returns nothing.
            messages = atrest.load_json_auto(raw, ns=ns)
