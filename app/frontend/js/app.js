...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // 5b. Scoped API keys (small local read; same shape as loadPlugins above).
  //     Populated at init rather than on panel-open so the list is already
  //     there when you go looking, which is when you are deciding whether a
  //     key is still wanted.
  if (window.loadApiKeys) loadApiKeys();
  ...
  console.log('%cVeridianAI ready', 'color:#f0a500;font-size:14px;font-weight:bold;font-family:Georgia,serif');
});
